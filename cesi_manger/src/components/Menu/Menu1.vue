...
export default {
  ...
  data() {
    return {
      // TODO(maybe): remove img and go with a for loop to reduce amount of code
      restaurantName: [
        'Chez Jojo',
        "C'est Caci parfait",
        "C'est Sésé qui régale",
        'Au bon bardon',
        "CES'EAT",
        'Salade bar',
      ],
      ...
      dishesNameCaci: ['Pâtes bolognaise', 'Pâtes carbonara', 'Cannelloni'],
      dishesNameSésé: [
        'Craquottes aux légumes bio',
        "Craquottes et verre d'eau",
        'Le festin Africain',
      ],
      dishesNameBardon: ['Bibimbap', 'Ddeokbokki', 'Barbecue coréen'],
      dishesNameCES: [
        'Pizza',
        'Burger',
        'Le tartare Vincent (photo non-contractuelle)',
      ],
      dishesNameBar: [
        'Salade gourmande',
        'Salade de pâtes',
