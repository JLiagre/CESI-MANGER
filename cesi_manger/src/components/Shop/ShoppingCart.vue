...
export default {
    ...
    data: () => ({
        cart: [
            { product_id: 1, product_name: "toto", product_price: 10.99, product_quantity: 2 },
            { product_id: 2, product_name: "titi", product_price: 5.99, product_quantity: 1 },
            { product_id: 3, product_name: "tata", product_price: 1.99, product_quantity: 5 }
        ]
    }),
    computed: {
        total() {
